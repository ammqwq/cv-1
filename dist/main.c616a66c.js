...
window.onload = function () {
  ...
  $$('#taiChispeed').oninput = function () {
    var taiChispeedValue = 101 - $$('#taiChispeed').value;
    var animation = "roll " + taiChispeedValue + "s linear infinite";
...
//# sourceMappingURL=/main.c616a66c.map